...
def dynamic_decode(decoder, output_time_major=False, impute_finished=False,
                   maximum_iterations=None, parallel_iterations=32,
                   swap_memory=False, scope=None, **kwargs):
  ...
  with tf.variable_scope(scope, "decoder") as varscope:
    ...
    if isinstance(decoder, TFDecoder):
    ...
    def condition(unused_time, unused_outputs_ta, unused_state, unused_inputs,
      ...
      cond_time = (maximum_iterations is None or unused_time < maximum_iterations)
