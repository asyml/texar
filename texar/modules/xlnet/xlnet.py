...
from texar.modules.xlnet import modeling
...
class XLNetModel(object):
    ...
    def __init__(self, xlnet_config, run_config, input_ids, seg_ids, input_mask,
        ...
        Args:
            ...
            input_mask: float32 Tensor in shape [len, bsz], the input mask. 0
                for real tokens and 1 for padding.
            ...
            target_mapping: float32 Tensor in shape [num_predict, len, bsz].
                ...
                on the j-th token.
                Only used during pretraining for partial prediction. Set to None
                during finetuning.
