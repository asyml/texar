...
python transformer_overall.py --max_train_epoch=40 --data_dir=${DATA_DIR} --src_language=en --tgt_language=de --batch_size=1536 --test_batch_size=10 --beam_width=5 --save_checkpoint_interval=2000 --log_disk_dir=${LOG_DISK_DIR} --alpha=0.6
