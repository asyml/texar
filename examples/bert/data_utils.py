...
class DataProcessor(object):
    ...
    def _read_tsv(cls, input_file, quotechar=None):
        ...
        with tf.gfile.Open(input_file, "r") as fin:
            reader = csv.reader(fin, delimiter="\t", quotechar=quotechar)
            lines = []
            for line in reader:
                lines.append(line)
            return lines
...
def convert_single_example(ex_index, example, label_list, max_seq_length,
    ...
    if ex_index < 5:
        ...
        tf.logging.info("length: %d" % len(input_ids))
...
def file_based_input_fn_builder(input_file, seq_length, drop_remainder, epoch, batch_size):
...
class BasicTokenizer(object):
    ...
    def _is_chinese_char(self, cp):
        ...
        # characters, despite its name. The modern Korean Hangul alphabet is
        # a different block, as is Japanese Hiragana and Katakana.
        # Those alphabets are used to write
