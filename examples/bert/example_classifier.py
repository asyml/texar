...
## Other parameters
flags.DEFINE_bool('sanity_check', False,
    ...
    with tf.variable_scope('bert'):
        with tf.variable_scope('embeddings'):
            ...
            token_type_embedder = tx.modules.WordEmbedder(
                vocab_size=bert_config['type_vocab_size'], hparams=bert_config.token_embed)
...
def model_fn_builder(bert_config, num_labels, init_checkpoint,
    ...
    def model_fn(features, labels, mode, params):    # pylint: disable=unused-argument
        ...
        if mode == tf.estimator.ModeKeys.TRAIN:
            ...
            lr = utils.get_lr(global_step, num_train_steps, num_warmup_steps, \
                down_config_model.opt)

            train_op = utils.get_train_op(total_loss, lr)
