...
from txtgen.modules.encoders.rnn_encoders import UnidirectionalRNNEncoder
from txtgen.modules.encoders.rnn_encoders import BidirectionalRNNEncoder
...
class UnidirectionalRNNEncoderTest(tf.test.TestCase):
    """Tests :class:`~txtgen.modules.UnidirectionalRNNEncoder` class.
    """
...
class BidirectionalRNNEncoderTest(tf.test.TestCase):
    """Tests :class:`~txtgen.modules.BidirectionalRNNEncoder` class.
    """
